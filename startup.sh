...
export DB_CONNECTION_STRING='Driver={ODBC Driver 17 for SQL Server};Server=tcp:webapptest-sqlserver.database.windows.net,1433;Database=mydatabase;Uid={daigo.hirayama@accenture.com};Encrypt=yes;TrustServerCertificate=no;Connection Timeout=30;Authentication=ActiveDirectoryIntegrated'
export PORT=61234
